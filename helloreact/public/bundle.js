	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('input', { type: 'text', ref: 'name', placeholder: 'Enter something what you want...' }),
	                React.createElement('br', null),
	                React.createElement('textarea', { name: 'message', id: 'message', cols: '21', rows: '5', ref: 'message' }),
	                React.createElement('br', null),
	                React.createElement(
	                    'button',
	                    null,
